...
description: >
  ...
  orders, media, conversations, setup links, status polling, and webhooks.
  Trigger on phrases like "Peach API", "developers.trypeach.ai", "send a
  WhatsApp template through Peach", "launch a Peach broadcast", "create a
  Peach contact", or "integrate Peach into my app".
metadata:
  version: 0.1.0
---
...
1. Identify the workflow first: messaging, templates, contacts, broadcasts, orders, media, conversations, micro-agents, or webhooks.
